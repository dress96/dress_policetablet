...
RegisterNUICallback('add-history', function(data, cb)
    ESX.TriggerServerCallback('dress_policetablet:add-history', function(event)
    cb(event)
  end, data)
end)

RegisterNUICallback('search-history',function(data,cb)
    ESX.TriggerServerCallback('dress_policetablet:search-history', function(event) 
        cb(event)
    end, data)
end)
RegisterNUICallback('fetch-history',function(data,cb)
    ESX.TriggerServerCallback('dress_policetablet:fetch-history', function(event) 
        cb(event)
    end, data)
end)